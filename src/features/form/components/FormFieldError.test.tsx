	...
	describe('rendering', () => {
		it('should not render when no errors', () => {
			const { container } = render(
				<FormFieldError fieldName="email" errors={{}} />
			);
		...
		it('should not render when errors is undefined', () => {
			const { container } = render(
				<FormFieldError fieldName="email" errors={undefined} />
			);
	...
	describe('multiple errors', () => {
		it('should show error for specified field only', () => {
			...
			const { rerender } = render(
				<FormFieldError fieldName="email" errors={errors} />
			);
			...
			rerender(
				<FormFieldError fieldName="password" errors={errors} />
			);
